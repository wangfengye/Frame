...
Java_com_maple_ffmpeg_VideoPlayer_sound(JNIEnv *env, jclass type, jstring input_jstr,
                                        jstring output_jstr) {
    ...
    // channel_layout =3.() AV_CH_FRONT_LEFT | AV_CH_FRONT_RIGHT
    LOGI("解码器: %s,声道:%d,AVSampleFormat: %d,channel_layout:%ld",codec->name,codecCtx->channels,codecCtx->sample_fmt,codecCtx->channel_layout);
    //打开解码器
