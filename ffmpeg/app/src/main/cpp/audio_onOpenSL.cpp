//
// Created by 10404 on 2019/10/23.
//
...
void CreateBufferQueueAudioPlayer(
    ...
    SLDataFormat_PCM dataSourceFormat = {
            ...
            static_cast<SLuint32>(wav_get_rate(wav) * 1000), // 毫赫兹/秒的样本数
...
Java_com_maple_ffmpeg_VideoPlayer_soundwavOnOpenSL(JNIEnv *env, jclass type, jstring jFileName) {
